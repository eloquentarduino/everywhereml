...
setup(
  ...
  download_url='https://github.com/eloquentarduino/everywhereml/blob/master/dist/everywhereml-0.2.22.tar.gz?raw=true',
  keywords=[
    'ML',
    'machine learning'
  ],
